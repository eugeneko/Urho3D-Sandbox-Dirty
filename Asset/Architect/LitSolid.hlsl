...
void VS(float4 iPos : POSITION,
        ...
        float4 iInstanceFade : TEXCOORD7,
    #endif
...
{
    // Discard pixels to fade-out
    //#ifdef INSTANCED
        float screenSpaceFade = Random(floor(iFragPos.xy));
